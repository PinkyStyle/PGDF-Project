...
public class PGDFApp {
    ...
    public static void main(String[] args) throws IOException, SQLException {
        ...
        System.out.println("import time: "+(totalTime/1000000) +"ms");
        switch(args[2]){
            case "pgdf":
                ...
                System.out.println("export pgdf time: "+(totalTime/1000000) +"ms");
                break;
            case "ypg":
                startTime = System.nanoTime();
                ...
                endTime   = System.nanoTime();
                totalTime = endTime - startTime;
                System.out.println("export ypg time: "+(totalTime/1000000) +"ms");
                break;
            case "gml":
                startTime = System.nanoTime();
                ...
                endTime   = System.nanoTime();
                totalTime = endTime - startTime;
                System.out.println("export gml time: "+(totalTime/1000000) +"ms");
                break;
            case "json":
                startTime = System.nanoTime();
